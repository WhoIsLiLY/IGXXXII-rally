    ...
    <div class="container mt-5 p-3">
        ...
        <div class="d-flex px-3 mb-5" style="justify-content:space-between; margin:5px;">
            <div class="text-white p-3 rounded-div div-color text-text d-grid" style="width:32%; align-items:center;">
                <div style="width:40%;color:black;"><h4 style="font-weight:bold;font-size:14px;">Jumlah Point:</h4></div>
                <h1>{{ $player->tupals->point }}</h1>
            </div>
            <div class="text-white p-3 rounded-div div-color text-text d-grid" style="width:32%; align-items:center;">
                <div style="width:40%;color:black;"><h4 style="font-weight:bold;font-size:14px;">Service Rate:</h4></div>
                @php
                    $totalServiceTime = 0;
            ...
            <div class="text-white p-3 rounded-div div-color text-text d-grid" style="width:32%; align-items:center;">
                <div style="width:40%;color:black;"><h4 style="font-weight:bold;font-size:14px;">Pelanggan Datang:</h4></div>
