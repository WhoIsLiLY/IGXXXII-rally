...
<body style = "background-color: #F6E3C7;">
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="row w-100">
            <div class="col-md-6 offset-md-3 col-lg-4 offset-lg-4 text-beige p-5 rounded" style="background-color: #6B0001;">
                ...
                <form method="POST" action="{{ route('login') }}" class = "text-text">
                    ...
                    <button type="submit" class="btn btn-primary w-100" style = "background-color: #C47932;border-color:#C47932;">Submit</button>
