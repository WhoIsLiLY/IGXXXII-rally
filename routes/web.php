...
Route::group(
    ...
    function () {
        ...
        Route::get('/kotalama/save-score', [PesertaKotalamaController::class, 'saveScore'])->name('save.score');
        Route::get('/kotalama/restart', [PesertaKotalamaController::class, 'restart'])->name('restart');
